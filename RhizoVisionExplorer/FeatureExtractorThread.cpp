...
void FeatureExtractorThread::setroottype(int type)
{
    roottype = type;
}

void FeatureExtractorThread::setsmooththreshold(double th)
{
    edgesmooththreshold = th;
}
...
void FeatureExtractorThread::run()
{
    ...
    config.saveprocessed = saveprocessed;
    config.savesegmented = savesegmented;
    config.conversion = pixel2mm;
    config.pixelconv = convertphysical;
    //config.rootlo = rootlo;
    //config.roothi = roothi;
    config.threshold = threshold;
    config.roottype = roottype;
    config.smooththresh = edgesmooththreshold;

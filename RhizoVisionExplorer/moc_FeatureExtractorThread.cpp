...
void FeatureExtractorThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FeatureExtractorThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FeatureExtractorThread::*)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FeatureExtractorThread::ReportProgress)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FeatureExtractorThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_FeatureExtractorThread.data,
    qt_meta_data_FeatureExtractorThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
